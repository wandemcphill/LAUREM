  ...
  return <main style={{padding:'24px 18px 70px',fontFamily:'system-ui',background:'#f4f7fb',minHeight:'100vh',color:'#102a43'}}>
    <div style={{maxWidth:1050,margin:'0 auto'}}>
      ...
      <section style={{background:'#fff',border:'1px solid #e5eaf0',borderRadius:16,padding:22,marginTop:14}}>
        ...
        : !document.requires_signature && document.category !== 'job_description' ? <div><h2 style={{marginTop:0}}>Acknowledgement</h2><p style={{color:'#627d98',lineHeight:1.6}}>This document is informational and does not require an electronic signature. Please keep it available in your Staff Portal.</p></div>
