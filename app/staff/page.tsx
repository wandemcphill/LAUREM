...
type MessageSummary = { id:string; subject?:string|null; updated_at?:string|null; unread?:boolean; other?:{name:string;jobTitle:string}|null; latest?:{body:string|null;created_at:string|null;sender_staff_id?:string|null}|null };
