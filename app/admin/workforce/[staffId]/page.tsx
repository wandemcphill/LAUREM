...
type Staff = { id:string; application_id:string|null; employee_number:string; full_name:string; email:string; phone:string|null; job_title:string; employment_status:string; start_date:string|null; end_date:string|null; location:string|null; nmc_number:string|null; right_to_work_verified:boolean; dbs_verified:boolean; contract_id:string|null; created_at:string; updated_at:string };
