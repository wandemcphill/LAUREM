...
export const LAUREM_JOBS: Job[] = [
  ...
  },
  {
    ...
    description: 'Senior support work involving care delivery, oversight, safeguarding, medication support, record keeping and teamwork.',
  ...
  },
  {
    ...
    description: 'Care work supporting personal care, wellbeing, nutrition, mobility, medication support where trained and safeguarding.',
