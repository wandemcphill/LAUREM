-- Care-role sponsorship policy:
-- Senior Support Worker and Care Worker / Healthcare Assistant opportunities
-- are UK-only roles for portal recruitment and any sponsorship consideration
-- is limited to eligible applicants already in the UK.
...
begin
  ...
  payload_living_in_uk := lower(btrim(coalesce(p_payload->>'living_in_uk', '')));
