-- Forward-only correction for PL/pgSQL output-variable/column ambiguity in the staff onboarding RPC.
-- Qualify columns whose names overlap the RPC's returned-column variables.
